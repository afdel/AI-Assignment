...
public class MiniMax {
	...
	private static Move calculateTheNextMove1(BoardState boardState) {
		...
		maxValue1( boardState, minimaxDepth);
...
//	}
	...
	private static int maxValue1(BoardState boardState, int depth){
		...
		int maxSuccesorsEvaluations = -1000;
		
		for(BoardState successorState : generateSuccessors( boardState, 1L)){
			
			int successorEvaluation = minValue1(successorState,depth-1);
			if( successorEvaluation>maxSuccesorsEvaluations){
				maxSuccesorsEvaluations = successorEvaluation;
		...
		return maxSuccesorsEvaluations;
	...
	private static int minValue1(BoardState boardState, int depth){
		...
		int minSuccesorsEvaluations = 1000;
		
		for(BoardState successorState : generateSuccessors( boardState, 2L)){
			
			int successorEvaluation = maxValue1(successorState,depth-1);
			if( successorEvaluation<minSuccesorsEvaluations){
				minSuccesorsEvaluations = successorEvaluation;
			}
		}
		
		return minSuccesorsEvaluations;
